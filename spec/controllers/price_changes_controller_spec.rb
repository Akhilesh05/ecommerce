...
RSpec.describe PriceChangesController, type: :controller do
  # This should return the minimal set of attributes required to create a valid
  # PriceChange. As you add validations to PriceChange, be sure to
  ...
  # PriceChangesController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe 'GET #index' do
    it 'returns a success response' do
      PriceChange.create! valid_attributes

...
RSpec.describe UsersController, type: :controller do
  ...
  describe 'POST #authenticate' do
    context 'when request valid' do
      before { post :authenticate, params: valid_credentials, as: :json }
    ...
    context 'when request invalid' do
      before { post :authenticate, params: invalid_credentials, as: :json }

      it { is_expected.not_to respond_with(:ok) }
    end
  end
